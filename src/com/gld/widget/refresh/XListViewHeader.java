...
public class XListViewHeader extends LinearLayout {
    ...
    private void initView(Context context) {
        // 初始情况，设置下拉刷新view高度为0
        LayoutParams lp =
                new LayoutParams(android.view.ViewGroup.LayoutParams.MATCH_PARENT, 0);
        mContainer =
        ...
        if (headerNormal == null) {
            ...
            mHintTextView.setText(headerNormal);
        }
            ...
            case STATE_READY:
                if (mState != STATE_READY) {
                    ...
                    if (headerReady == null) {
                        ...
                        mHintTextView.setText(headerReady);
                    }
                }
                break;
